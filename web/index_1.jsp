                ...
                <div class="col-lg-5 offset-lg-1">
                    <div class="about_info">
                        <div class="section_title white_text">
                            ...
                            <p class="mid_text wow fadeInUp" data-wow-duration="1s" data-wow-delay=".5s">A Group Of Students Ttrying To Help And Mold The Education Into A Better Shape.</p>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="section_title text-center mb-90">
                        ...
                        <p class="wow fadeInUp" data-wow-duration="1s" data-wow-delay=".6s">"Text Summarization,Which Helps You To Escape Unnecessary Details."</p>
                    </div>
                </div>
            </div>
            <div class="row">
